    ...
    <div className="pt-24 container mx-auto max-w-[1700px]">
      <div className=" bg-[url('case_study/BG-1.png')] bg-cover bg-center">
        <div className="p-4 h-[611px] max-w-[1300px] mx-auto pt-28">
          ...
          <p className="md:text-[16px] font-[500] font-poppins leading-6 max-w-[420px] ">
            ...
            and selection. It ensures a smooth hiring process and a strong
            talent match.
          </p>
        </div>
      </div>
        ...
        <div className="min-h-[322px] p-10 max-w-[1300px] mx-auto">
          <div>
            ...
            <p className="text-[#546E7A] text-[16px] font-poppins">
              ...
              deliverables, offering a quick snapshot of the project's purpose
              and progress.
            </p>
          </div>
              ...
              <ul className="list-none space-y-2">
                ...
                <li className="flex items-start">
                  ...
                  <p className="text-[#546E7A] text-[16px]">
                    ...
                    personalization, slow application processes, or poor
