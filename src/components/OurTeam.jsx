...
const OurTeam = () => {
  return (
    <div className="bg-[url('public/bgimg/curve.png')] bg-contain bg-no-repeat">
      <div className="flex flex-col md:flex-row justify-between py-12 px-20 max-w-screen-xl m-auto ">
        {/* Left Section (Text) */}
        <div className="max-w-full md:max-w-xl w-full md:w-[60%] flex flex-col justify-center items-start mb-8 md:mb-0">
          <h2 className="text-customYellow text-4xl font-semibold mb-4">
            OUR TEAM
          </h2>
          <p className="leading-8 py-4 text-[#546E7A] max-w-md text-[18px] font-[400]">
